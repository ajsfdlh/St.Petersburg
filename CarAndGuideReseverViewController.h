//
//  CarAndGuideReseverViewController.h
//  St.Petersburg
//
...
@interface CarAndGuideReseverViewController : UIViewController<NSURLConnectionDataDelegate,UITextFieldDelegate>{
    UIScrollView *sv;
...
@property (nonatomic , copy)NSString *carAndGuideTypeStr;
//导游公司
@property (nonatomic , copy)NSString *CNUStudentStr;
//租车个人
@property (nonatomic , copy)NSString *carTypeStr;
@property (nonatomic , copy)NSString *jichengStr;
...
@property (nonatomic ,copy)NSMutableString *selectDateStr;
...
@property (nonatomic , retain)NSArray *CGArr;
